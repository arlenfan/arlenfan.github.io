...
const About = () => {
  return (
    <div className="about-container">
        ...
        <div className="hero-content">
          <div className="hero-text">
            <h1 className="hero-title">
              Hi, I'm <span className="highlight">Arlen Fan</span>
            </h1>
            ...
            <div className="social-links">
              ...
              <a href="https://scholar.google.com/citations?user=youruserid" className="social-link" aria-label="Google Scholar">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
      ...
      {/* Future sections for blog posts, publications, and projects */}
      {/*
